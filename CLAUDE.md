...
# Claude Project Rules (High-Level)

This file defines ONLY the essential, project-level rules that Claude must follow when working on the Building Materials Marketplace application.

All technical, framework-specific, or environment-specific rules are located in:
